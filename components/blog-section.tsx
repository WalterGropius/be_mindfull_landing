    ...
    <section className="bg-background py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-3 justify-items-center">
          {blogPosts.map((post) => (
            <div key={post.slug} className="flex flex-col w-full max-w-[388px] h-[644px] bg-white border border-[#C0D1C6] rounded-[24px] overflow-hidden">
              ...
              <div className="flex flex-col items-center flex-grow p-[24px] md:p-[32px] text-center w-full">
                ...
                <p className="text-[18px] leading-[30px] text-[#4B4C4D] flex-grow">{post.excerpt}</p>
